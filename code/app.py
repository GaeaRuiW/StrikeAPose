...
async def inference_api(inference_request: InferenceRequest):
    ...
    output_json_path = f"{os.path.dirname(output_json_path)}/{action_id}-{os.path.basename(output_json_path)}"
    ...
    def inference_thread():
        try:
            ...
            success = inference(action_id, video_path, output_video_path, output_json_path)
            if success:
