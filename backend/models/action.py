...
class Action(SQLModel, table=True):
    ...
    def __init__(self, patient_id: int, status: str, progress: str, create_time: str, update_time: str, is_deleted: bool, parent_id: int = None, original_video_id: int = None):
