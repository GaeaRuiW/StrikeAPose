...
class StepHipDegree(SQLModel, table=True):
    ...
    def __init__(self, action_id: int, step_id: int, low: float, high: float, left_feet: bool, right_feet: bool, create_time: str, update_time: str, is_deleted: bool):
